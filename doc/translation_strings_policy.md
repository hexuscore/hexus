...
This document provides guidelines for internationalization of the Hexus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hexus_en.ts` remains unchanged.
