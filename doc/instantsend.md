...
This mechanism has been integrated into Bitcore-Node-Hexus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hexuspay/insight-api-hexus#web-socket-api](https://github.com/hexuspay/insight-api-hexus#web-socket-api)
* API: [https://github.com/hexuspay/insight-api-hexus#instantsend-transactions](https://github.com/hexuspay/insight-api-hexus#instantsend-transactions)
...
By default, the Hexus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hexus Core daemon:
