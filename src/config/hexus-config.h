/* src/config/hexus-config.h.  Generated from hexus-config.h.in by configure.  */
/* src/config/hexus-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Hexus Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Hexus Core"
...
#define PACKAGE_BUGREPORT "https://github.com/hexuspay/hexus/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Hexus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Hexus Core 0.12.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "hexuscore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://hexus.org/"
