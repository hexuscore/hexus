...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in hexus.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("hexus.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Hexus features */
    { "hexus",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "hexus",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "hexus",               "gobject",                &gobject,                true,  {} },
    { "hexus",               "voteraw",                &voteraw,                true,  {} },
