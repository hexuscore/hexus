...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Hexus address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "hexus",               "masternode",             &masternode,             true,  {} },
    { "hexus",               "masternodelist",         &masternodelist,         true,  {} },
    { "hexus",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "hexus",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "hexus",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "hexus",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
