    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  hexus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Hexus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 HXS, 0.1 HXS, 1 HXS and 10 HXS -- sort of like the paper money you use every day.</li> \
