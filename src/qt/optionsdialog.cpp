    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("HXS-light"), QVariant("light"));
    ui->theme->addItem(QString("HXS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("HXS-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("HXS-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("HXS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("HXS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("HXS-traditional"), QVariant("trad"));
